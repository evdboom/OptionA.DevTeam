...
internal static class CommandOptionValidator
{
    ...
    private static Dictionary<string, HashSet<string>> CreateCliCommandOptions()
    {
        ...
        return new Dictionary<string, HashSet<string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["run"] = CreateOptionSet(sharedOptions: globalOptions, "backend", "max-iterations", "max-subagents", "timeout-seconds", "verbosity", "keep-awake"),
            ["run-loop"] = CreateOptionSet(sharedOptions: globalOptions, "backend", "max-iterations", "max-subagents", "timeout-seconds", "verbosity", "keep-awake"),
