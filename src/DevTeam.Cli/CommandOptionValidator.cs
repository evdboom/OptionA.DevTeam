...
internal static class CommandOptionValidator
{
    ...
    private static Dictionary<string, HashSet<string>> CreateCliCommandOptions()
    {
        ...
        return new Dictionary<string, HashSet<string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["run"] = CreateOptionSet(sharedOptions: globalOptions, "backend", "max-iterations", "max-subagents", "timeout-seconds", "verbosity", "keep-awake", "dry-run"),
            ["run-loop"] = CreateOptionSet(sharedOptions: globalOptions, "backend", "max-iterations", "max-subagents", "timeout-seconds", "verbosity", "keep-awake", "dry-run"),
    ...
    private static Dictionary<string, HashSet<string>> CreateInteractiveCommandOptions() =>
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["plan"] = CreateOptionSet("backend", "max-iterations", "max-subagents", "timeout-seconds", "verbosity", "keep-awake"),
            ...
            ["run"] = CreateOptionSet("backend", "max-iterations", "max-subagents", "timeout-seconds", "verbosity", "keep-awake", "dry-run"),
            ["run-loop"] = CreateOptionSet("backend", "max-iterations", "max-subagents", "timeout-seconds", "verbosity", "keep-awake", "dry-run"),
