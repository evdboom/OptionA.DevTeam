...
var tests = new List<(string Name, Action Run)>
{
    ...
    ("SDK session config wires BYOK provider", TestSdkSessionConfigWiresByokProvider),
    ...
    ("Provider command updates runtime configuration", TestSetProviderCommandUpdatesRuntimeConfiguration),
    ...
    ("Set-pipeline command updates default roles", TestSetPipelineCommandUpdatesDefaultRoles),
